...
import ani.saikou.Uri
import ani.saikou.client
import ani.saikou.parsers.*
import anime.extractors.BetaPlayer
import anime.extractors.KickAssAnimeV2
import anime.extractors.Maverickki
import anime.extractors.PinkBird
import kotlinx.serialization.Serializable
import parsers.anime.extractors.*
...
class KickAssAnime : AnimeParser() {
    ...
    override suspend fun getVideoExtractor(server: VideoServer): VideoExtractor? {
        ...
        val data = server.extraData ?: return null

        val referralServer = {
            var url = data.get("data_segment").toString()
